namespace Caesar.Services.Helpers;
public static class ArgumentsParser
{
    public static bool GetRequiredFlag(string[] args, int index, string argSwitch)
    {
        var argumentValue = GetValue(args, index, string.Empty, false);
    ...
    {
        var argumentValue = GetValue(args, index, string.Empty, true);
